					...
					<div className="flex flex-col gap-3">
						...
						<table className="w-full text-xs">
							...
							<tbody className="text-muted">
								...
								<tr className="border-t border-foreground/10 hover:bg-foreground/5 transition-colors"><td className="py-2 pr-6 font-mono">sewStyle</td><td className="py-2 pr-6">&apos;machine&apos;</td><td className="py-2">&apos;machine&apos; — satin cross-rows fill each stroke in parallel. &apos;hand&apos; — a single continuous thread wanders stitch by stitch, like hand embroidery.</td></tr>
